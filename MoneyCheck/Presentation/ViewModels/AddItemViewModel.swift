...
final class AddItemViewModel: BaseViewModel<AddItemRouterProtocol>, ItemViewModelProtocol {
    ...
    // MARK: - Initialization
    init(type: ItemType, financeUseCase: FinanceUseCase, router: AddItemRouterProtocol) {
        self.type = type
