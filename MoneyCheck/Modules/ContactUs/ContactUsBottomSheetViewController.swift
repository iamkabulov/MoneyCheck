...
public class ContactUsBottomSheetViewController: UIViewController {
...
private extension ContactUsBottomSheetViewController {
    ...
    func setupLayout() {
        view.addSubview(bottomSheetTitle)
        ...
        stackView.snp.makeConstraints { make in
            ...
            make.leading.trailing.equalToSuperview().inset(Constants.Spacing.medium)
            make.bottom.equalToSuperview().inset(Constants.Spacing.extraLarge)
        }
    }
